...
export default class Addemployer extends Component {
    constructor(props) {
        super(props);
        this.state = ({
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    <Link to='/contact2'><img style={{marginLeft: this.state.width * 0.02}} src={require('../icon/arrow_left.svg')}></img></Link>
                </div>
                <div style={{
                    display: 'flex',
                    width: this.state.width * 0.85,
